(async()=>{
  ...
  document.querySelector('#restore-backup').click();await wait(50);
  check('backup recovery asks through the app confirmation',document.querySelector('#confirmation').open);
